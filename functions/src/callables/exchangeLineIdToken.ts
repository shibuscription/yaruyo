...
type ExchangeLineIdTokenRequest = {
  idToken: string;
  channelId?: string;
};

export const exchangeLineIdToken = onCall({ region: "asia-northeast1" }, async (request) => {
  const body = request.data as ExchangeLineIdTokenRequest;
